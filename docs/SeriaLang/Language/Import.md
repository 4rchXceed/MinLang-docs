...
```ucl
%import path/to/your/file.ucl # Or uchc
```
...
- **Absolute Path**: The full path to the file from the root of the filesystem. For example, `%import /home/user/project/src/lib/file.ucl`.
